...
namespace Aderant.Build.Analyzer.Refactorings {
    ...
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(ReverseTypeNameRefactoring)), Shared]
    internal class ReverseTypeNameRefactoring : CodeRefactoringProvider {
