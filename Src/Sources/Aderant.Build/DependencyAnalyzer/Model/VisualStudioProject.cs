...
namespace Aderant.Build.DependencyAnalyzer.Model {
    ...
    internal class VisualStudioProject : IEquatable<VisualStudioProject>, IDependencyRef {
        ...
        public ProjectBuildConfiguration ProjectBuildConfiguration { get; set; }

        /// <summary>
        /// Get or set the list of assemblies, projects and other objects within the build for which this projects depends
        /// </summary>
