...
Function Get-RemoteSession($remoteMachineName) {
    ...
    # 30 minute timeout
    $sessionOptions = New-PSSessionOption -OperationTimeout 1800000
    
    $session = New-PSSession $remoteMachineName -Auth CredSSP -Cred $credential -SessionOption $sessionOptions
    return $session
}
