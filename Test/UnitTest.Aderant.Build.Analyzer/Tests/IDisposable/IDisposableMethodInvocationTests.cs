...
namespace UnitTest.Aderant.Build.Analyzer.Tests.IDisposable {
    ...
    public class IDisposableMethodInvocationTests : IDisposableRuleBaseTests {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IDisposableMethodInvocationTests"/> class.
        /// </summary>
        public IDisposableMethodInvocationTests() :
            base(null) {
        }
        ...
        public IDisposableMethodInvocationTests(RuleBase[] injectedRules)
            : base(injectedRules) {
        }
...
";
        ...
        [TestMethod]
        public void IDisposableMethodInvocationRule_ChildCollection() {
            const string code = @"
using System;
...
namespace Aderant.Framework.SoftwareFactory.Integration.UI {
    public partial class ModelElementTree {
    ...
    partial class ModelElementTree {
...
";
        ...
        [TestMethod]
        public void IDisposableMethodInvocationRule_Collection_ClassField_Invocation_Add() {
            const string code = @"
using System;
using System.Collections.Generic;
using Aderant.Framework.Extensions;
...
";
        ...
        [TestMethod]
        public void IDisposableMethodInvocationRule_Collection_ClassField_Invocation_AddRange() {
            const string code = @"
using System;
using System.Collections.Generic;
using Aderant.Framework.Extensions;
...
";
        ...
        [TestMethod]
        public void IDisposableMethodInvocationRule_Collection_ClassProperty_Invocation_Add() {
            const string code = @"
using System;
using System.Collections.Generic;
using Aderant.Framework.Extensions;
...
namespace Test {
    public class Test : IDisposable {
        public List<IDisposable> Items { get; set; }
...
";
        ...
        [TestMethod]
        public void IDisposableMethodInvocationRule_Collection_ClassProperty_Invocation_AddRange() {
            const string code = @"
using System;
using System.Collections.Generic;
using Aderant.Framework.Extensions;
...
";
        ...
        [TestMethod]
        public void IDisposableMethodInvocationRule_Collection_LocalVariable_Invocation_Add() {
            const string code = @"
using System;
using System.Collections.Generic;
using Aderant.Framework.Extensions;
...
";
        ...
        [TestMethod]
        public void IDisposableMethodInvocationRule_Collection_LocalVariable_Invocation_AddRange() {
            const string code = @"
using System;
using System.Collections.Generic;
using Aderant.Framework.Extensions;
